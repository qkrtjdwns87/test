...
?>
                <!-- 주문정보 타이틀 -->
                    ...
                    <tr>
                        <th>수취인명</th>
                        <td><input type="text" name="rcvr_name" class="w100" value="홍길순"/></td>
                    </tr>
                    <!-- 수취인 연락처1(rcvr_tel1) -->
                    <tr>
                        <th>수취인 전화번호</th>
                    ...
                    <tr>
                        <th>수취인 휴대폰번호</th>
                        <td class="sub_input1"><input type="text" name="rcvr_tel2" class="w100" value="010-0000-0000"/></td>
                    </tr>
                    <!-- 수취인 E-mail(rcvr_mail) -->
                    <tr>
                        <th>수취인 E-mail</th>
                        <td><input type="text" name="rcvr_mail" class="w200" value="honggilsoon@kcp.co.kr" size="30" maxlength="30" /></td>
                    </tr>
                    <!-- 수취인 우편번호(rcvr_zipx) -->
                    <tr>
                        <th>수취인 우편번호</th>
                    ...
                    <tr>
                        <th>수취인 주소</th>
                        <td><input type="text" name="rcvr_add1" class="w200" value="서울시 구로구"/></td>
                    </tr>
                    <tr>
                        <th>수취인 상세주소</th>
                        <td><input type="text" name="rcvr_add2" class="w200" value="170-5 우림E-biz센터"/></td>
                    </tr>
                </table>
<?
    /* = -------------------------------------------------------------------------- = */
