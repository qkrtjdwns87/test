...
<body onload="jsf__chk_type();init_orderid();chk_pay();create_goodInfo();">
<div id="sample_wrap">
...
<form name="pay_form" method="post" action="pp_cli_hub.php" accept-charset="EUC-KR" onsubmit="return emulAcceptCharset(this)">
