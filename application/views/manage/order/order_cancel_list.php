<?
	...
	$listUrl = '/manage/order_m/cancellist'.$addUrl;
...
<div id="container">
	<div id="content">
		...
		<?
			...
			{
				$col2 = $ordStatsToDaySet['STATE_5110'];
				$col3 = $ordStatsToDaySet['STATE_5115'];
				$col4 = $ordStatsToDaySet['STATE_5120'];
			}			
			
			//일자를 무시한 통계인 경우
			/*			
			if (isset($ordStatsToDaySet[0]['STATE_5110']))
			{
		...
		<table class="write2">
			...
			?>			
				...
				<?}?>
					...
					<td width="8%"><?=substr($rs['CANCEL_DATE'], 0, 10)?></td>
					<td width="8%"><?=substr($rs['CANCEL_END_DATE'], 0, 10)?></td>
				</tr>
			<?
					$tmpOrderNum = $rs['NUM'];
		...
		<div class="btn_list">
			...
			<!-- PG연동이 필요한 부분<a href="javascript:grpOrderChange('5150', '환불승인');" class="btn1 fl_r">환불승인 처리</a> -->
			<a href="javascript:grpOrderChange('5115', '취소불가');" class="btn1 fl_r">취소불가 처리</a>
			<!-- PG연동이 필요한 부분<a href="javascript:grpOrderChange('5120', '취소완료');" class="btn1 fl_r">취소완료 처리</a> -->
		</div>
