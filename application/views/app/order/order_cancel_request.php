...
<div id="wrap">
	...
	<input type="hidden" name="orderstate" value="5110"/>
	<!-- 구매취소 -->
	<section id="order_popup">
		<ul class="title">
			<li>구매취소 신청 전에 '교환 및 환불정책'을 살펴 봐주세요.</li>
			<li>Item 제작상태와 Item 성격에 따라 구매취소신청이 어려울 수 있습니다.</li>
		</ul>

		<div class="select_box">
			<select id="reason_cd" name="reason_cd">
				<option value="" selected="selected">취소신청 사유선택</option>
		<?
			$i = 1;
	...
	<div class="order_btn_list">
		<a href="javascript:sendRequest();">취소신청</a></li>
	</div>
	<!-- //메뉴바 -->
</div>
