...
&bullet; 사이즈  : Free / Adjustable Small (9 ~ 13호)</textarea>
		...
		<table class="write1 mg_t10">
			...
			<tbody>
				<tr>
					...
					<td>7 건</td>
					<th>총 공유 건수</th>
					<td>7 건 <div>(PC웹 4건 / 모바일앱 3건)</div></td>
				</tr>
			</tbody>
		</table>
		...
		<div class="btn_list">
			...
			<a href="" class="btn1 fl_l">등록정보 복사</a>

			<a href="" class="btn2 fl_r">저장</a>
			<a href="" class="btn2 fl_r">삭제</a>
			<a href="" class="btn2 fl_r">목록</a>
		</div>
