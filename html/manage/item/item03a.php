...
<div id="container">
	<div id="content">
		...
		<table class="write1">
			<colgroup><col width="13%" /><col width="15%" /><col width="13%" /><col width="31%" /><col width="13%" /><col width="15%" /></colgroup>
			<tbody>
				<tr>
					<th>진행상태</th>
					<td colspan="5">진행 중</td>
				</tr>
				<tr>
					<th>제 목</th>
					<td colspan="5"><input type="text" id="" class="inp_sty60" /></td>
				</tr>
				<tr>
					<th>작성자</th>
					<td>홍길동</td>
				...
				<tr>
					...
					<td colspan="5">
						<dl class="dl_img">
							...
							<dd>
								<a href="" class="alink">1233-small.jpg</a><a href="#" class="close"><img src="/images/adm/btn_close.gif" alt="닫기" />
							</dd>
