...
<div id="container">
	<div id="content">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
						...
						<label><input type="checkbox" id="" name="" class="inp_check" />환불신청</label>
						<label><input type="checkbox" id="" name="" class="inp_check" />환불보류</label>
						<label><input type="checkbox" id="" name="" class="inp_check" />환불승인</label>
						<label><input type="checkbox" id="" name="" class="inp_check" />환불불가</label>
						<label><input type="checkbox" id="" name="" class="inp_check" />환불완료</label> <br />
						<label><input type="checkbox" id="" name="" class="inp_check" />반품처리중</label>
						<label><input type="checkbox" id="" name="" class="inp_check" />반품수거완료</label>
					</td>
				</tr>
				<tr>
					<th>Item명</th>
		...
		<div class="btn_list">
			...
			<a href="" class="btn1 fl_r">반품수거완료 처리</a>
			<a href="" class="btn1 fl_r">환불불가 처리</a>
			<a href="" class="btn1 fl_r">환불완료 처리</a>
			<a href="" class="btn1 fl_r">환불승인 처리</a>
			<a href="" class="btn1 fl_r">환불보류 처리</a>
		</div>
