...
<div id="popup">
	...
	<table class="write1 mg_t10">
		...
		<tbody>
			...
			<tr>
				...
				<td><span class="tdline">결제인</span> <strong>김성규</strong></td>
			</tr>
			<tr>
				<td class="bo_tn"><span class="tdline">결제정보</span><strong>휴대폰 결제</strong></td>
			</tr>
			<tr>
				<th>거래증빙신청</th>
				<td><span class="tdline">세금계산서</span>
	...
	<table class="write1 mg_t10">
		...
		<tbody>
			<tr>
				<th>환불방법</th>
				<td class="bo_tn bold"><span class="tdline">휴대폰 결제 취소 <span class="red">완료</span>
				(2016-01-20 12:22)</span>
				</td>
			</tr>
			<tr>
				<th>환불금액</th>
