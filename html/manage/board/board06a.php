	...
	<div id="content">
		...
		<div class="comment">
			...
			<ul class="comment_ul">
				<li>
					<dl class="comment_dl">
						<dt><img src="/images/adm/default_img.gif" width="80" alt="shop 이미지" /></dt>
						<dd class="day">2016-01-10 12:22:11</dd>
						<dd class="text">주문량이 너무 많아서 임시휴업을 하려고 하는데요.다른 방법은 없을까요? <br />다른 방법을 좀 알려주십시오.휴업은 피하고 싶어요.<br />주문량이 너무 많아서 임시휴업을 하려고 하는데요.다른 방법은 없을까요? <br />다른 방법을 좀 알려주십시오.휴업은 피하고 싶어요.</dd>
					</dl>
				</li>
				<li class="comment_craftshop">
					<dl class="comment_dl">
						<dt><img src="/images/adm/default_img.gif" width="80" alt="shop 이미지" /></dt>
						<dd class="day">2016-01-10 12:22:11</dd>
						<dd class="text">주문량이 너무 많아서 임시휴업을 하려고 하는데요.다른 방법은 없을까요? <br />다른 방법을 좀 알려주십시오.휴업은 피하고 싶어요.<br />주문량이 너무 많아서 임시휴업을 하려고 하는데요.다른 방법은 없을까요? <br />다른 방법을 좀 알려주십시오.휴업은 피하고 싶어요.</dd>
		...
		<table class="write1 mg_t10">
			...
			<tr>
				<th>이미지 첨부</th>
				<td><input type="file" id="" class="inp_file" /></td>
			</tr>
		</table>

		<div class="btn_list">
			<a href="" class="btn1">내용지우기</a>
			<a href="" class="btn1">보내기</a>
		</div>
