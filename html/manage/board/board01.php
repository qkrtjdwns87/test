...
<div id="container">
	<div id="content">
		...
		<table class="write2 cboth">
			<colgroup><col width="5%" /><col width="5%" /><col width="63%" /><col width="7%" /><col width="10%" /><col width="5%" /><col width="5%" /></colgroup>
			<thead>
				<tr>
					<th></th>
					<th>No</th>
			...
			<tbody>
				<tr>
					...
					<td>101</td>
					<td class="ag_l"><a href="" class="alink">DEAR MAISON”의 작가 Maison</a></td>
					<td>홍길동</td>
					<td>2016-05-10</td>
					<td>54</td>
					<td>16</td>
